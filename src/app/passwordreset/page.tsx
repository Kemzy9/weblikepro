...
export default function PasswordReset() {
    ...
    return (
        <div className="flex flex-col items-center justify-center min-h-screen py-2 container bg-gradient-to-r from-[#315aed] to-[#5d91f1] hover:from-[#000000] hover:to-[#f5f4fb] text-white">
            <HoverCard>
                <HoverCardTrigger>
