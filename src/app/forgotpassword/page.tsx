...
export default function ForgotPasswordPage() {
    ...
    return (
        <div className="flex flex-col justify-center items-center py-4 min-h-screen bg-gradient-to-r from-[#315aed] to-[#5d91f1] hover:from-[#000000] hover:to-[#f5f4fb] text-white">
